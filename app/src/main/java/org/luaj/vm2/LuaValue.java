...
public class LuaValue extends Varargs {
    ...
    public static Varargs varargsOf(final LuaValue[] v) {
        return switch (v.length) {
            ...
            default -> new ArrayVarargs(v, NONE);
        };
    }
    ...
    public static Varargs varargsOf(final LuaValue[] v, Varargs r) {
        return switch (v.length) {
            ...
            case 1 -> r.narg() > 0 ?
                    ...
                    v[0];
            case 2 -> r.narg() > 0 ?
                    new ArrayVarargs(v, r) : new PairVarargs(v[0], v[1]);
    ...
    public static Varargs varargsOf(final LuaValue[] v, final int offset, final int length) {
        return switch (length) {
            case 0 -> NONE;
            case 1 -> v[offset];
            case 2 -> new PairVarargs(v[offset + 0], v[offset + 1]);
            default -> new ArrayPartVarargs(v, offset, length, NONE);
        };
    }
