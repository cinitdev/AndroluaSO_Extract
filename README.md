 ...
 * 点击右上角的 Settings -> 左侧菜单栏的 Secrets and variables -> Actions。
 * 点击 New repository secret 按钮，逐一添加以下 4 个 Secret：
| Secret 名称 | 你的值 |
|---|---|
| PYROGRAM_API_ID | 填入你从 Telegram 网站获取的 api_id |
| PYROGRAM_API_HASH | 填入你从 Telegram 网站获取的 api_hash |
| TELEGRAM_BOT_TOKEN | 填入你从 @BotFather 获取的机器人 Token |
| TELEGRAM_CHAT_ID | 填入你从 @userinfobot 获取的 CHAT_ID |
